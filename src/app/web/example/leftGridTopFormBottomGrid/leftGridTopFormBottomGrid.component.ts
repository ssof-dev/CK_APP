...
* 생성/수정일 					작성자          내용
* ===========================================================
* 2021-08-20 12:35:56                         최초생성
*/
declare var Ext: any;
import { Component, OnInit, Input } from '@angular/core';
import { LeftGridTopFormBottomGridModel } from './model/leftGridTopFormBottomGrid.model';
...
@Component({
	selector: 'app-leftGridTopFormBottomGrid',
	templateUrl: './leftGridTopFormBottomGrid.component.html',
	providers: [ApiHttpServiceImpl],
})
export class LeftGridTopFormBottomGridComponent implements OnInit {
	...
	//조회 Model
	public searchModel: LeftGridTopFormBottomGridModel = <LeftGridTopFormBottomGridModel>{};

	//form model
	public formModel: LeftGridTopFormBottomGridModel = <LeftGridTopFormBottomGridModel>{};
	...
	public gridSelectModel : Array<LeftGridTopFormBottomGridModel>;
	...
	//신규 버튼 이벤트
    onTapNew(){
        this.formModel = <LeftGridTopFormBottomGridModel>{};
        this.isFormEdit = false;
