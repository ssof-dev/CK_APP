...
* 생성/수정일 					작성자          내용
* ===========================================================
* 2021-08-20 15:54:38                         최초생성
*/
declare var Ext: any;
import { Component, OnInit, Input } from '@angular/core';
import { LeftGridCenterFormModel } from './model/leftGridCenterForm.model';
...
@Component({
	selector: 'app-leftGridCenterForm',
	templateUrl: './leftGridCenterForm.component.html',
	providers: [ApiHttpServiceImpl],
})
export class LeftGridCenterFormComponent implements OnInit {
	...
	//조회 Model
	public searchModel: LeftGridCenterFormModel = <LeftGridCenterFormModel>{};

	//form model
	public formModel: LeftGridCenterFormModel = <LeftGridCenterFormModel>{};

	//그리드 체크박스 선택한 데이터 Model array
	public gridSelectModel : Array<LeftGridCenterFormModel>;
    ...
    //신규 버튼 이벤트
    onTapNew(){
        this.formModel = <LeftGridCenterFormModel>{};
        this.isFormEdit = false;
